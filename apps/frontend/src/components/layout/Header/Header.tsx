      ...
      <div className="fixed left-0 right-0 top-0 z-30 bg-muted">
        <div>
          <div className="hidden md:block">
            ...
            >
              <nav id="header-desktop-navbar" className="container relative flex max-w-[1680px] items-center gap-x-2">
                <ul className="group z-10" id="desktopMegamenuWrapper">
                  ...
                  <div className="absolute top-full w-full max-w-[1000px]">
                    <div className="relative hidden rounded-b-lg bg-muted shadow-base" id="desktopMegamenu">
                      <div className="flex h-[450px] max-h-[450px] w-full overflow-hidden rounded-b-lg pt-0.5">
                        ...
                        <div className="main-scroll w-50 overflow-y-auto bg-background" dir="ltr">
                          <ul dir="rtl" id="mega-menu-parents">
                            <li>
                              <Link className="flex py-4 pr-4" href="./shop.html">
                                {" "}
                                مردانه{" "}
                              </Link>
                            </li>
                        ...
                        <div className="main-scroll h-[450px] max-h-[450px] w-full overflow-auto" dir="ltr">
                          <div className="flex grow p-5" dir="rtl" id="mega-menu-childs">
                            ...
                            <div className="hidden">
                              {/* <!-- head --> */}
                              <div className="mb-4">
                                <Link className="flex items-center gap-x-1 py-2 text-sm text-primary" href="./shop.html">
                                  <div>مشاهده همه</div>
                              ...
                              <div className="flex grow flex-wrap gap-x-14 gap-y-8">
                                <div className="space-y-2">
                                  <Link className="flex items-center gap-x-2 hover:text-primary" href="./shop.html">
                                  ...
                                  <ul>
                                    <li>
                                      <Link className="block py-2 text-sm text-text/90 hover:text-primary" href="./shop.html">
                                        {" "}
                                        شلوار{" "}
                                      </Link>
                                    </li>

...
Breadcrumb.Link = ({ className, to = "", active = false, children, key = 0, ...attr }: LinkProps) => {
  ...
  return (
    <li
      className={clsx([
        className,
        key > 0 && "relative mr-5 pl-0.5",
        !breadcrumb.light &&
          key > 0 &&
          "before:content-[''] before:w-[14px] before:h-[14px] before:bg-bredcrumb-chevron-dark before:bg-[length:100%] before:-mr-[1.125rem] before:absolute before:my-auto before:inset-y-0",
        breadcrumb.light &&
          key > 0 &&
          "before:content-[''] before:w-[14px] before:h-[14px] before:bg-bredcrumb-chevron-light before:bg-[length:100%] before:-mr-[1.125rem] before:absolute before:my-auto before:inset-y-0",

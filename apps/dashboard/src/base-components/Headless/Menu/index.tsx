    ...
    >
      <div
        className={clsx([
          ...
          placement == "top-end" && "left-0 bottom-[100%]",
          placement == "left-start" && "left-[100%] translate-y-[-50%]",
          placement == "left" && "left-[100%] top-[50%] translate-y-[-50%]",
          placement == "left-end" && "left-[100%] bottom-0",
          placement == "bottom-end" && "top-[100%] left-0",
...
Menu.Divider = (props: React.ComponentPropsWithoutRef<"div">) => {
  return <div className={twMerge(["h-px my-2 -mx-2 bg-slate-200/60 dark:bg-darkmode-400", props.className])}></div>;
};

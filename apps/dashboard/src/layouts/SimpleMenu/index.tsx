...
function Menu(props: {
  ...
  return (
    <Tippy
      ...
      className={clsx([
        "h-[50px] flex items-center pr-5 text-white mb-1 relative rounded-lg",
        {
          ...
          "after:content-[''] after:w-[20px] after:h-[80px] after:ml-[-27px] after:bg-no-repeat after:bg-cover after:absolute after:top-0 after:bottom-0 after:right-0 after:my-auto after:bg-menu-active dark:after:bg-menu-active-dark":
            props.menu.active && props.level == "first",
          ...
          // Animation
          "after:ml-[-47px] after:opacity-0 after:animate-[0.3s_ease-in-out_1s_active-side-menu-chevron] after:animate-fill-mode-forwards":
            props.menu.active && props.level == "first",
        },
        props.className,
      ])}

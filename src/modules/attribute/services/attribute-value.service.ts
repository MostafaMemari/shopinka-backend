...
export class AttributeValueService {
  ...
  async findAll({ page, take, ...queryAttributeValueDto }: QueryAttributeValueDto): Promise<unknown> {
    ...
    const { name, slug, sortBy, sortDirection, startDate, attributeId, buttonLabel, colorCode, endDate, includeAttribute } =
  ...
  ): Promise<{ message: string; attributeValue: AttributeValue }> {

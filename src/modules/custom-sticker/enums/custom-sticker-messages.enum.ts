export enum CustomStickerMessages {
  NotFoundCustomSticker = 'Custom sticker not found.',
  UpdatedCustomStickerSuccess = 'Custom sticker updated successfully.',
  RemovedCustomStickerSuccess = 'Custom sticker removed successfully.',
  ...
  CalculatedStickerPriceSuccess = 'Sticker price calculated successfully.',
}
